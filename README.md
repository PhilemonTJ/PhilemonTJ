...
## 💻 Tech Stack:
 <img src="https://go-skill-icons.vercel.app/api/icons?i=vscode,cursor,eclipse,googlecolab,replit,pycharm,python,c,cpp,java,dart,markdown,pytorch,tensorflow,sklearn,numpy,pandas,matplotlib,scipy,seaborn,opencv,html,css,javascript,typescript,bootstrap,jquery,vite,react,tailwindcss,expressjs,mongoose,mongodb,streamlit,npm,flutter,androidstudio,canva,figma,inkscape,blender,git,github,docker,linux,ubuntu,bash,mysql,sqlite,chatgpt,claude,deepseek,gemini,langchain,pinecone,llamaindex,looker,tableau,pbi&perline=13"/>
